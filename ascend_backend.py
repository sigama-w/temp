...
class AscendAttnBackend(AttentionBackend):
    ...
    def init_forward_metadata(self, forward_batch: ForwardBatch):
        ...
        if forward_batch.extend_prefix_lens is not None:
            self.forward_metadata.extend_prefix_lens = forward_batch.extend_prefix_lens.int()
        else:
            self.forward_metadata.extend_prefix_lens = torch.zeros(
        ...
        if not self.use_mla:
            ...
            if sinks is not None:
                ...
                attn_out = attention_sinks_prefill_triton(
                    ...
                    block_tables,
                    self.forward_metadata.extend_prefix_lens,
                    layer.scaling,
